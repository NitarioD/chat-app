...
mongoose.connect(`mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@cluster0.uyq5q.mongodb.net/storageDB?retryWrites=true&w=majority`);
...
const groupedConversationSchema= new mongoose.Schema({
  users: Array,
...
const Group= new mongoose.model('group', groupedConversationSchema);
